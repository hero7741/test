<?php 
	...
	$sql="select * from test order by dateline desc";
...
<div id="page">
	...
	<?php
		...
		<div class="post">
			...
			<div class="entry"><?php echo $value['description']?></div>
				<div class="meta">
					<p class="link"><a href="article.show.php?id=<?php echo $value['id']?>">detail</a>&nbsp;&nbsp;&raquo&nbsp;&nbsp; </p>
				</div>
		</div><?php
		}
		}
